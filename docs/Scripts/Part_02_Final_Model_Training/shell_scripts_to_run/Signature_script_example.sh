...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
home_dir=~/Documents/Demo/MixTRTpred/Scripts/Part_02_Final_Model_Training/
sif_dir=~/Documents/Demo/MixTRTpred/Scripts/Computation_Environement/MixTRTpred_singularity.sif

# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Define the scripts:
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
script_dir=~/Documents/Demo/MixTRTpred/Scripts/R_script/02_Model_Training_CV.R

# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Define the parameters:
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
path_config=~/Documents/Demo/MixTRTpred/Scripts/Part_02_Final_Model_Training/Model_configs/Signature_models.yml
