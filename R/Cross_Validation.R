...
GetModelPrediction <- function(data.input, data.output, y.label, 
                               ...
                               LR.model.file.name = NULL, LR.prob.threhsold = 0.5){
...
#' 
#' @param CV.res data.frame; Nested-Cross-Validation results as returned by NestedCrossValidation()
